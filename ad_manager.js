/*************************************************************
  ...
  Develop a basic W3.CSS interface.
    ...
    v13 Add numeric validation
		...
		Adapted by Steven Leishman term 2 2021
		V1 Initial code
		V2 taylored to fit my program
*************************************************************/
...
function ad_home() {
  ...
  // ENSURE THE HTML ID ARE CORRECT                                      //<=======
  s_gamePg.style.display    = "none";                                  //<=======
  s_adminPg.style.display   = "none";                                  //<=======
  s_homePg.style.display = "block";                                 //<=======
}
...
function ad_BB() {
  ...
  document.getElementById("b_adHome").style.backgroundColor = "grey"; 
  // ENSURE THE READ FUNCTION NAME & THE PATH NAME ARE CORRECT           //<=======
  fb_readAll(STATS,'', ad_processBBReadAll);                                   //<=======
}
  ...
  if (_result == 'OK') {
    _dbRec.forEach(function(childSnapshot) {
      ...
      ad_adminArray.push({
        ...
        houseNumber:  childData.houseNumber,
